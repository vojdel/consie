...
create table personal (
	...
	s_nombre_personal varchar(20) default '',
	p_apellido_personal varchar(20) not null,
	s_apellido_personal varchar(20) default '',
...
create table representante (
	...
	s_nombre_representante varchar(20) default '',
	p_apellido_representante varchar(20) not null,
	s_apellido_representante varchar(20) default '',
...
create table funcionario (
	...
	s_nombre_fun varchar(20) default '',
	p_apellido_fun varchar(20) not null,
	s_apellido_fun varchar(20) default '',
...
CREATE OR REPLACE VIEW view_usuario_reporte AS 
    SELECT
                u.usuario, 
                u.p_secreta, 
                f.funcion 
    FROM usuario AS u 
    INNER JOIN usuario_funcion AS us ON
    u.id_usuario=us.id_usuario INNER JOIN funcion AS f ON
    us.id_funcion=f.id_funcion ORDER BY u.id_usuario;
